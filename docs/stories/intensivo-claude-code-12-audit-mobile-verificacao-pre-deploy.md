...
depends_on: [Story 11]
status: done (manual tests pending)
created: 2026-04-22
...
1. [x] Rodar `landing-page-audit` (skill dedicada) — gera `docs/mobile-audit.md`
2. [x] Revisar 13 itens SEO via `curl` no `dist/index.html`:
   ```bash
